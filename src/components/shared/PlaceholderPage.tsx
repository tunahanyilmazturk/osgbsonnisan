...
export default function PlaceholderPage({ title, description }: { title: string, description: string }) {
  return (
    ...
    >
      <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-4">
        <div>
      ...
      <motion.div variants={itemVariants} className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-200/60 dark:border-slate-700/60 p-12 flex flex-col items-center justify-center min-h-[400px] text-center">
