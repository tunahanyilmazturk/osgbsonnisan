...
import { Plus, Trash2, LayoutGrid, List, Upload, RotateCcw, Download } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
      ...
      <div className="flex flex-wrap gap-2 lg:gap-3 w-full lg:w-auto">
        ...
        <Button variant="primary" icon={<Plus size={18} />} onClick={onAddPersonnel} className="shrink-0">
